...
android.permissions = INTERNET,POST_NOTIFICATIONS,RECEIVE_BOOT_COMPLETED,SCHEDULE_EXACT_ALARM,FOREGROUND_SERVICE,WAKE_LOCK
android.enable_androidx = True

# Network security config to allow cleartext traffic to localhost
